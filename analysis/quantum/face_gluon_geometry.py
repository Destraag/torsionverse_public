...
print(f"    T1g: constructive (phi) at vertices -> TRANSVERSE field")
print(f"    T2g: destructive (-1/phi) at vertices -> SHEAR / TWIST field")
print()
print(f"  In solid mechanics: T1g = transverse vector mode (propagates undamped")
print(f"                      through vertices, dim=3, W/Z/photon field)")
...
print()
print(f"  T1g (W/Z) couples ALONG the C5 axes at each vertex -> OUTWARD (Born) COUPLING")
...
print(f"  T1_g     3  Transverse       +phi       W/Z gauge bosons (massless)")
...
print(f"    T1g = transverse field (vertex-coupled)")
...
print(f"  T1g (transverse field, W/Z):    dim = {dim_T1}")
...
print(f"    NOTE: the dim=3*3=9 product itself is not I_h-unique (any group with")
print(f"    two 3-dim irreps gives the same dimension count); what's specific to I_h")
print(f"    is T1g x T2g containing NO A_g component (G+H only), verified above.")
print()
